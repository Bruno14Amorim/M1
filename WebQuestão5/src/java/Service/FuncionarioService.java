...
public class FuncionarioService {
    ...
    static FuncionarioController Controller = new FuncionarioController();
    ...
    @Path("/insert")
    public Response saveJson(Funcionario obj) {
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/update/{id}")
    public Response saveJsonPut(@PathParam("id") int id, Funcionario obj) {
        try {
            System.out.println(obj.toString());
