...
public class PessoaFisicaService {
    ...
    static PessoaFisicaController Controller = new PessoaFisicaController();
    ...
    @Path("/insert")
    public Response saveJson(PessoaFisica obj) {
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/update/{id}")
    public Response saveJsonPut(@PathParam("id") int id, PessoaFisica obj) {
        try {
            System.out.println(obj.toString());
