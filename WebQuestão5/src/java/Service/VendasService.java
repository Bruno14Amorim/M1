...
public class VendasService {
    ...
    static VendasController Controller = new VendasController();

    @GET
    @Path("/lista")
    @Produces(MediaType.APPLICATION_JSON)
    public List<Vendas> getFuncionarios() {
    ...
    @Path("/insert")
    public Response saveJson(Vendas obj) {
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/update/{id}")
    public Response saveJsonPut(@PathParam("id") int id, Vendas obj) {
        try {
            System.out.println(obj.toString());
